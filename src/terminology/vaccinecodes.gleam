pub const vaccine_codes: List(#(String, String)) = [
  ...
  #("138", "Td (adult)"),
  #("09", "Td (adult), 2 Lf tetanus toxoid, preservative free, adsorbed"),
  ...
  #("GNHIB", "HIB"),
  #("GNHPA", "Hepatitis A"),
  #("GNJEN", "Japanese Encephalitis"),
  #("GNMEA", "Measles"),
  #("GNMEN", "Meningococcal C"),
  #("GNMUM", "Mumps"),
  #("GNPNE", "Pneumococcal"),
  #("GNPOL", "Polio"),
  #("GNROX", "Rotavirus"),
